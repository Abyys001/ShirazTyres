...
class AppConfig {
  ...
  /// the mock Google identity, and the OTP the mock SMS provider hands back
...
/// The list used to live here as a `const`, which meant an account created in
/// the panel never appeared on this screen, and the numbers drifted out of date
